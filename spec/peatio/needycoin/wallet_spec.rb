RSpec.describe Peatio::Needycoin::Wallet do
  let(:wallet) { Peatio::Needycoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Needycoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Needycoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
